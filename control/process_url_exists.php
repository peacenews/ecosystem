...
The code below (lines 85-98 of this file) should be insterted at control/processes.php line 240 and the subsequent line ammended to add the url test...
if(($emailcount[0] >= 1) && ($groupcount[0] == 0) && ($urlexists == 0)){
and
}else if (($emailcount[0] == 0) && ($groupcount[0] == 0) && ($urlexists == 0)){
