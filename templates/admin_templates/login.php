...
<form method="post" action="" class="">
    ...
    <input type="email" id="email" name="admin_email" value="" placeholder="example@domain.com" required /><br>

    <label for="password">Password: <span class="required">*</span></label>
    <input type="password" id="invitename" name="admin_pass" value="" placeholder="password" required />
