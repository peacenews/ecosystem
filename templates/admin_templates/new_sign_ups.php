...
<h4>Update existing user new group welcome email:</h4>
<form action="" method="post">
    <input name="app_subject" type="text" value="<?php echo $app_subject1 ?>" /><br />
    <textarea name="app_content" cols="" rows="" class="tinymce ta"><?php echo $app_message1 ?></textarea><br />
    <input name="update_email" type="hidden" value="existinguser_groupapproval"/>
    <input name="update" type="submit" value="Update" />
</form>
