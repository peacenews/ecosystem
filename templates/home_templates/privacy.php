    ...
    <div class="row">
        ...
        <div class="row content first">
            ...
            <div class="large-8 columns">
                ...
                <h3 class="bold purple">Subheading</h3>
                <p>Body text</p>

                <div class="leaf-bg text-center">
                    <img src="img/background.png"> <!-- Background image -->
                </div><!--leaf-bg text-center-->
                <div class="back-to-top text-center">
                    <div class="text-center"><img src="/img/back-to-top.png"><!--To top image--></div><!--text-center-->
